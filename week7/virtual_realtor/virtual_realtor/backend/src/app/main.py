...
from tools import search_properties, store_qa, search_qa
...
by either looking up the information about the properties in the database using a search_qa tool or in the knowledge base.
if infrmaiton if found in the knowledge base, be sure to add it to the database for future reference using the store_qa tool.
...
def session(id: str) -> Agent:
    tools = [retrieve, store_qa, search_qa]
