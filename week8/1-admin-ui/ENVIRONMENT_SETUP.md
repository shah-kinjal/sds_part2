...
Before deploying the application, you need to set up the following environment variables:
...
Create a `.env` file in the `week8/1-admin-ui` directory:
...
1. Create a `.envrc` file in the `week8/1-admin-ui` directory
